...
const makePathToModuleAbsolute = (relativePath) => path.join(path.resolve(), relativePath);

// eslint-disable-next-line import/no-dynamic-require, global-require
const getModule = (relativePath) => require(makePathToModuleAbsolute(relativePath));
